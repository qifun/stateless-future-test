...
class UncheckedBoundsSpec {
  ...
  @Test def insufficientLub_SI_7694() {
    suppressingFailureBefore2_10_3 {
      eval( s"""
      object Test {
        import _root_.com.qifun.statelessFuture.test.run.toughtype._
        import _root_.com.qifun.statelessFuture.test.internal.AsyncId.{async, await}
        async {
  ...
  @Test def insufficientLub_SI_7694_ScalaConcurrent() {
    suppressingFailureBefore2_10_3 {
      ...
      object Test {
        import _root_.com.qifun.statelessFuture.test.run.toughtype._
        import _root_.com.qifun.statelessFuture.test.Async.{async, await}
